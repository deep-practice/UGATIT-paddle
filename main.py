...
def parse_args():
    ...
    parser.add_argument('--n_res', type=int, default=2, help='The number of resblock')
    parser.add_argument('--n_dis', type=int, default=3, help='The number of discriminator layer')
    parser.add_argument('--light_pool_size', type=int, default=1, help='The pool size of avg pooling in light mode')
